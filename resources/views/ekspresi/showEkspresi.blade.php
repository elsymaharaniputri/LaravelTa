...
<head>
    ...
    <title>{{ $title ?? 'EKSPRESI LIST' }}</title>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            ...
                            <div
                                ...
                                <a href="{{ route('ekspresi.form') }}" class="btn btn-outline-primary me-2"
                                    target="_blank" style="width:10rem;">
                                    <i class='bx bx-plus'></i> Tambahkan
                                </a>
                            </div>
                            <table id="example" class="table table-striped  mb-3">
                                ...
                                <tbody class="mb-5">
                                    @forelse ($ekspresis as $ekspresi)
                                        <tr>


                                            <td>{{ $ekspresi->name_ekspresi }}</td>
                                            <td>{{ $ekspresi->desc_ekspresi }}</td>
                                            <td>
                                                <img src="{{ asset('ekspresi/' . $ekspresi->icon_ekspresi) }}"
                                                    class="rounded w-75">
                                            </td>
                                            <td>
                                                <div class="dropdown">
